...
export const APP_IMAGES_ORIGIN =
  import.meta.env.VITE_APP_IMAGES_ORIGIN ??
  "https://rhubaiafd-bag6ftb7h5eqexfh.z02.azurefd.net";

// API Configuration
export const API_CONFIG = {
  // Base URL for API calls - production server
  BASE_URL:
    import.meta.env.VITE_API_BASE_URL || "https://api.rhubaia.com/admin",
  ...
  ENDPOINTS: {
    ...
    DASHBOARD: {
      ...
      FINANCE_SUMMARY: "/dashboard/stats/finance-summary",
      ACTIVITY: "/dashboard/activity",
      MONETIZATION_FINANCE: "/dashboard/analytics/monetization-finance",
    ...
    SUBSCRIPTIONS: {
      ...
      MANUAL_TRANSACTION_DETAILS:
        "/subscriptions/manual/transaction/:transactionId",
    },
    CONTACT_SUPPORT: {
